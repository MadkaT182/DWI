...
local Combo = STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetCurrentCombo();

local Marvelous = string.format("% 5d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W1"));
local Perfect = string.format("% 5d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W2"));
local Great = string.format("% 5d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W3"));
local Good = string.format("% 5d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W4"));
local Ok = string.format("% 5d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetHoldNoteScores("HoldNoteScore_Held"));
local Miss = string.format("% 5d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_Miss"));
local Almost = string.format("% 5d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W5"));

local Score = string.format("% 9d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetScore());
